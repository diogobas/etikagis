<%@ Page Title="GIS - Cadastro de Indicador" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmIndicador.aspx.vb" Inherits="Backend.frmIndicador" %>
							...
							<ul>
								...
								<li><asp:Label ID="Label1" runat="server" Text="Filtro:" />
                                    <asp:DropDownList id="cmbFiltro" runat="server" Width="180px" >
                                        ...
                                        <asp:ListItem>Aspecto</asp:ListItem>
							...
							<legend style="color:#B0C4DE;">Dados</legend>
							    <table>
                                    ...
                                    <tr>
									    <td>Indicador*</td>
                                        <td>
                                            <asp:TextBox ID="txtIndicador" runat="server" Width="103px"></asp:TextBox>
                                        </td>
								    </tr>	

                                    <tr>
									    <td>Descrição* </td> <td style="margin-left: 40px">
                                        <asp:TextBox ID="txtDescricao" runat="server" MaxLength="200" Width="406px" 
                                            Height="71px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
								    </tr>

                                    <tr>
									    <td>Aspecto*</td> <td>                         
                                        <asp:DropDownList ID="cmbAspecto" runat="server" Width="406px">
                                        </asp:DropDownList>
                                        </td>
								    </tr>
				...
				<tr>
					<td colspan="2">
                        <asp:Panel ID="Panel1"  runat="server" ScrollBars="Horizontal" Width="900px" 
                            style="margin-left:10px; margin-top:20px;" Height="362px">
						    <asp:GridView ID="gridIndicador" runat="server" 
                                style="margin-top: 0px; margin-left:0px;" CellPadding="4" ForeColor="#333333" 
                                Font-Size="Small">

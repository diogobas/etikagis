<%@ Page Title="Status" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmStatus.aspx.vb" Inherits="Backend.frmStatus" %>
                        ...
                        <fieldset class="frame">	
							<legend style="color:#B0C4DE;">Dados</legend>
							    <table>
								    ...
								    <tr>
									    <td>Status* </td> <td style="margin-left: 40px">
                                        <asp:TextBox ID="txtStatus" runat="server" MaxLength="200" Width="386px"></asp:TextBox>
                                        </td>
								    </tr>	                                                                                                                                            
                                    
                                    <tr>
									    <td>Tipo</td> <td>                         
                                        <asp:DropDownList ID="cmbTipo" runat="server" Width="202px">
                                            <asp:ListItem></asp:ListItem>

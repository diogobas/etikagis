...
Public Class QuestionarioDAL
    ...
    Sub ExcluiQuestionario(codQuestionario As Integer)
        Try
            Dim dal As New BDDAL(COMUM.strConexao, True)
            Dim param() As SqlParameter
    ...
    Function RetornaStatusQuestionario(parametros As Array) As DataSet
        Try
            ...
            param = {dal.CriarParametro("@cd_empresa", SqlDbType.Int, parametros(0)), _
                     ...
                     dal.CriarParametro("@cd_status", SqlDbType.Int, parametros(3)), _
                     dal.CriarParametro("@dt_competencia", SqlDbType.Int, parametros(4))}
    ...
    Function RetornaUltimaCompetencia(cd_representante As Integer) As DataSet
        Try
            ...
            Return dal.GetDataSet("st_sgs_ultima_competencia_s", CommandType.StoredProcedure, param)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
